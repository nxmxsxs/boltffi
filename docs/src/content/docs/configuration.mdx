---
title: "Configuration"
description: "Configure boltffi.toml package names, target outputs, and platform packaging behavior for generated Swift, Kotlin, Java, and TypeScript bindings."
---
...
The default output is `dist/java`. This produces Java sources, a C header, JNI glue, and a compiled shared library. Requires `JAVA_HOME` and `clang`.
