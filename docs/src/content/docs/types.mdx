---
title: "Types"
description: "Reference how Rust types map to Swift, Kotlin, Java, and TypeScript in BoltFFI, including supported primitives, collections, and performance notes."
---
...
<TypeTable
  title="Integers"
  mappings={[
    { rust: "i8", swift: "Int8", kotlin: "Byte", java: "byte", typescript: "number" },
    { rust: "i16", swift: "Int16", kotlin: "Short", java: "short", typescript: "number" },
    { rust: "i32", swift: "Int32", kotlin: "Int", java: "int", typescript: "number" },
    { rust: "i64", swift: "Int64", kotlin: "Long", java: "long", typescript: "bigint" },
    { rust: "u8", swift: "UInt8", kotlin: "UByte", java: "byte", typescript: "number" },
    { rust: "u16", swift: "UInt16", kotlin: "UShort", java: "short", typescript: "number" },
    { rust: "u32", swift: "UInt32", kotlin: "UInt", java: "int", typescript: "number" },
    { rust: "u64", swift: "UInt64", kotlin: "ULong", java: "long", typescript: "bigint" },
  ]}
/>
...
<TypeTable
  ...
  mappings={[
    { rust: "f32", swift: "Float", kotlin: "Float", java: "float", typescript: "number" },
    { rust: "f64", swift: "Double", kotlin: "Double", java: "double", typescript: "number" },
    { rust: "bool", swift: "Bool", kotlin: "Boolean", java: "boolean", typescript: "boolean" },
    { rust: "String", swift: "String", kotlin: "String", java: "String", typescript: "string" },
  ]}
/>
...
<TypeTable
  title=""
  mappings={[
    { rust: "Vec<T>", swift: "[T]", kotlin: "List<T>", java: "List<T>", typescript: "T[]" },
    { rust: "Option<T>", swift: "T?", kotlin: "T?", java: "T (nullable)", typescript: "T | null" },
    { rust: "Result<T, E>", swift: "throws", kotlin: "throws", java: "throws", typescript: "throws" },
  ]}
/>
...
<TypeTable
  title=""
  mappings={[
    { rust: "Duration", swift: "TimeInterval", kotlin: "Duration", java: "Duration", typescript: "Duration" },
    { rust: "SystemTime", swift: "Date", kotlin: "Instant", java: "Instant", typescript: "Date" },
    { rust: "Uuid", swift: "UUID", kotlin: "UUID", java: "UUID", typescript: "string" },
    { rust: "Url", swift: "URL", kotlin: "URI", java: "URI", typescript: "string" },
    { rust: "Vec<u8>", swift: "Data", kotlin: "ByteArray", java: "byte[]", typescript: "Uint8Array" },
  ]}
/>
...
<TypeTable
  ...
  mappings={[
    { rust: "std::time::Duration", swift: "TimeInterval", kotlin: "Duration", java: "Duration", typescript: "Duration" },
    { rust: "std::time::SystemTime", swift: "Date", kotlin: "Instant", java: "Instant", typescript: "Date" },
    { rust: "uuid::Uuid", swift: "UUID", kotlin: "UUID", java: "UUID", typescript: "string" },
    { rust: "url::Url", swift: "URL", kotlin: "URI", java: "URI", typescript: "string" },
    { rust: "Vec<u8>", swift: "Data", kotlin: "ByteArray", java: "byte[]", typescript: "Uint8Array" },
  ]}
/>
